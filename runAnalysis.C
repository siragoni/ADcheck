...
// opt = 1; 2018 r
{
    ...
    if(local) {
        ...
        if (opt == 0) alienHandler->SetGridWorkingDir("PbPb18q_XNXN_noAD5");
        if (opt == 1) alienHandler->SetGridWorkingDir("PbPb18r_XNXN_noAD5");
        if (opt == 2) alienHandler->SetGridWorkingDir("PbPb15o_XNXN_noAD5");
