...
// opt = 1; 2018 r
{
...
#if !defined (__CINT__) || defined (__CLING__)
    gInterpreter->LoadMacro("AliAnalysisTaskADin2018.cxx++g");
    AliAnalysisTaskADin2018 *task = reinterpret_cast<AliAnalysisTaskADin2018*>(gInterpreter->ExecuteMacro("AddTaskADin2018.C"));
#else
    gROOT->LoadMacro("AliAnalysisTaskADin2018.cxx++g");
    gROOT->LoadMacro("AddTaskADin2018.C");
    AliAnalysisTaskADin2018 *task = AddTaskADin2018();
#endif
    ...
    if(local) {
        ...
        alienHandler->SetAdditionalLibs("AliAnalysisTaskADin2018.cxx AliAnalysisTaskADin2018.h");
        alienHandler->SetAnalysisSource("AliAnalysisTaskADin2018.cxx");
        ...
        if (opt == 0) alienHandler->SetGridWorkingDir("PbPb18q_XNXN_noAD_SPD");
        if (opt == 1) alienHandler->SetGridWorkingDir("PbPb18r_XNXN_noAD_SPD2");
        if (opt == 2) alienHandler->SetGridWorkingDir("PbPb15o_XNXN_noAD_SPD");
