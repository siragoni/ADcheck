...
void fitPtROOFitCoherent( const char* AnalysisName, const int selectionFlag, const int selectionFlag2, Double_t rSigma2s1s = 0.150 )
{
  // ---------------------------------------------------
  ...
  if        ( selectionFlag2 == 0 ) {
    ...
    fCohPsi2sToMuOrig       = (TH1F*)listingsMC[1]->FindObject("fTemplatePtDistributionRapidityMoreH_1");
    fCohPsi2sToMuPiOrig     = (TH1F*)listingsMC[2]->FindObject("fTemplatePtDistributionRapidityMoreH_1");
    fIncohJpsiToMuOrig      = (TH1F*)listingsMC[3]->FindObject("fTemplatePtDistributionRapidityMoreH_1");
    fIncohPsi2sToMuOrig     = (TH1F*)listingsMC[4]->FindObject("fTemplatePtDistributionRapidityMoreH_1");
    fIncohPsi2sToMuPiOrig   = (TH1F*)listingsMC[5]->FindObject("fTemplatePtDistributionRapidityMoreH_1");
    fTwoGammaToMuMediumOrig = (TH1F*)listingsMC[6]->FindObject("fTemplatePtDistributionRapidityMoreH_1");
    fTwoGammaToMuHighOrig   = (TH1F*)listingsMC[7]->FindObject("fTemplatePtDistributionRapidityMoreH_1");
    fCohJpsiToMuOrig        = (TH1F*)listingsMC[0]->FindObject("fTemplatePtDistributionRapidityMoreH_1");
    // fCohPsi2sToMuOrig       = (TH1F*)listingsMC[1]->FindObject("fTemplatePtDistributionH");
    // fCohPsi2sToMuPiOrig     = (TH1F*)listingsMC[2]->FindObject("fTemplatePtDistributionH");
    // fIncohJpsiToMuOrig      = (TH1F*)listingsMC[3]->FindObject("fTemplatePtDistributionRapidityMoreH_1");
  ...
  if        ( selectionFlag  == 0 ) { // COHERENT analysis
    ...
    // if      ( selectionFlag2 == 0 ) ngl = 9450 ;
    // else if ( selectionFlag2 == 1 ) ngl = 1856 ;
    // else if ( selectionFlag2 == 2 ) ngl = 5336 ;
    // else if ( selectionFlag2 == 3 ) ngl = 2230 ;
    // else                            ngl = 9450 ;
  } else if ( selectionFlag  == 2 ) { // 0NXN
    // if      ( selectionFlag2 == 0 ) ngl =  864 ;
    // else if ( selectionFlag2 == 1 ) ngl =  135 ;
    // else if ( selectionFlag2 == 2 ) ngl =  484 ;
    // else if ( selectionFlag2 == 3 ) ngl =  232 ;
    // else                            ngl =  864 ;
  } else if ( selectionFlag  == 3 ) {
    // if      ( selectionFlag2 == 0 ) ngl =  810 ;
    // else if ( selectionFlag2 == 1 ) ngl =   97 ;
    // else if ( selectionFlag2 == 2 ) ngl =  430 ;
    // else if ( selectionFlag2 == 3 ) ngl =  265 ;
    // else                            ngl =  810 ;
  } else if ( selectionFlag  == 4 ) {
    // if      ( selectionFlag2 == 0 ) ngl =  592 ;
    // else if ( selectionFlag2 == 1 ) ngl =   65 ;
    // else if ( selectionFlag2 == 2 ) ngl =  316 ;
    // else if ( selectionFlag2 == 3 ) ngl =  187 ;
    // else                            ngl =  592 ;
  } else {
    ngl =  592 ;
  }
