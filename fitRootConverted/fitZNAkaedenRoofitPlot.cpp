...
void fitZNA(const char* AnalysisName){
  ...
  fZNAEnergyAgainstEntriesH->GetXaxis()->SetTitle("ZNA Energy [GeV]");
  ...
  frame->SetTitle(  Form(  ";ZNA Energy [GeV];Counts / (%.0f a.u.)",
                           fZNAEnergyAgainstEntriesH->GetXaxis()->GetBinWidth(1)  )  );
   ...
   */
   ...
   gPad->SaveAs("pngResults/fZNAEnergyKaedenRoofitPlot.png", "RECREATE");
